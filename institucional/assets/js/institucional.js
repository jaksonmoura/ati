document.addEventListener("DOMContentLoaded", function(){
    let buscaBtn = document.querySelector(".search-btn");
    let buscaBox = document.querySelector(".search-box");
    let buscaInput = document.querySelector("input#search-input");

    buscaBtn.addEventListener("click", function(){
        buscaBox.classList.toggle("show-search-box");
        if (buscaBox.classList.contains("show-search-box")) {
            setTimeout(() => {
                buscaInput.focus();
            }, 100);
        }
